    ...
    return (
        <div className="mx-5 my-5 bg-white shadow-md px-5 py-5 rounded-xl">
            ...
            <div className="flex justify-between my-5">
                <button type="button" className="py-2 px-10 bg-indigo-600 hover:bg-indigo-700 text-white uppercase font-bold rounded" onClick={() => setEdicion(paciente)}>
                    Editar
                </button>
                <button type="button" className="py-2 px-10 bg-red-600 hover:bg-red-700 text-white uppercase font-bold rounded" onClick={() => eliminarPaciente(_id)}>
                    Eliminar
                </button>
            </div>
        </div>
