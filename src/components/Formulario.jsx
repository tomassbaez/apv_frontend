    ...
    return (
        <>
            ...
            <form className="bg-white py-10 px-5 mb-10 lg:mb-5 shadow-md rounded-md" onSubmit={handleSubmit}>
                ...
                <input type="submit" value={ id ? 'Guardar Cambios' : 'Guardar Paciente'} className="bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-700 cursor-pointer rounded-md"/>
            </form>
